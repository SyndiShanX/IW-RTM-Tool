...
namespace syndishanx_iw_tool {
    public partial class MainWindow : Window {
        ...
        private void Set_Contracts_Button_Click(object sender, RoutedEventArgs e) {
            Memlib.WriteMemory(addressBase + "5ECB661", "bytes", "4F C3 00 00 29 02 4F C3 00 00 29 02");
            Log_TextBox.Text = "Contracts Set!";
        }

        private void Reroll_Contracts_Button_Click(object sender, RoutedEventArgs e) {
            Memlib.WriteMemory(addressBase + "5ECB66D", "bytes", "67");
            Log_TextBox.Text = "Contracts Rerolled!";
        }
